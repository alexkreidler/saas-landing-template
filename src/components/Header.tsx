...
export default function Header(props) {
  ...
  const Section = (props) => {
    ...
    const hbg = useColorModeValue("gray.50", "gray.600");
  ...
  const Features = (props) => {
    const hbg = useColorModeValue("gray.50", "brand.50");
    const hbgh = useColorModeValue("gray.100", "brand.100");
    const tcl = useColorModeValue("gray.900", "gray.50");
    return (
      <React.Fragment>
        <SimpleGrid
  ...
  return (
    <React.Fragment>
      <chakra.header
        ...
        bg={bg}
        sx={{ position: 'sticky', top: '0', zIndex: 99999}}
        // borderTop="6px solid"
        ...
        <chakra.div h="4.5rem" mx="auto" maxW="7xl">
          ...
          >
            ...
            <Flex justify="flex-end" align="center" color="gray.400">
              <HStack spacing="2" display={{ base: "none", md: "flex" }} mr="6">
